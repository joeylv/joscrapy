...
##
## ![Alt text](../md/img/05215125-b820c4303f6f4f31b15a441975a1b674.png)  一、 模式定义  

##
## 代理模式就是给一个对象提供一个代理，并由代理对象控制对原对象的引用。  

##
## 在代理模式中，“第三者”代理主要是起到一个中介的作用，它连接客户端和目标对象。  二、 模式结构  

##
## 下图是代理模式UML结构图  

##
## ![Alt text](../md/img/05215126-1e85f55c8ea546ab9c92d6f542812350.jpg)  
