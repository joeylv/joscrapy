...
##
## ![Alt text](../md/img/616953-20161124095349737-1635431714.png)

##
##　　3.1 请求协议

##
##　　对于请求协议而言，如下为获取节点数据请求的完整协议定义 ![Alt text](../md/img/616953-20161124103957878-1344513149.png)　　	    class RequestHeader {        int xid;        int type;    	}
...
##
## ![Alt text](../md/img/616953-20161124105254362-1595181138.png)
