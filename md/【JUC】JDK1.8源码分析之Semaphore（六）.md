...
分析源码可以知道，Semaphore底层是基于[AbstractQueuedSynchronizer](http://www.cnblogs.com/leesf456/p/5350186.html)来实现的，所以，Semaphore的数据结构也依托于AQS的数据结构，在前面对AQS的分析中已经指出了其数据结构，在这里不再累赘。
...
![](../md/img/leesf456/616953-20160420212139476-6022765.png)
...
![](../md/img/leesf456/616953-20160420212905913-940764610.png)
...
![](../md/img/leesf456/616953-20160420222127366-1952818264.png)
...
![](../md/img/leesf456/616953-20160420222923460-914178481.png)
...
![](../md/img/leesf456/616953-20160421095847210-1224097514.png)
...
![](../md/img/leesf456/616953-20160421141725038-1821868274.png)
说明：此时，可以看到，Sync
queue中只有一个结点，头结点与尾节点都指向该结点，在setHeadAndPropagate的函数中会设置头结点并且会unpark队列中的其他结点。

⑦ t2线程执行semaphore.release操作。主要的函数调用如下图所示。

![](../md/img/leesf456/616953-20160421142516179-1917933280.png)
