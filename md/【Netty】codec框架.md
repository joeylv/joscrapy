...
假设你收到一个包含简单int的字节流，每个int都要单独处理。
此时将从入站ByteBuf读取每个int，并将其传递给下一个ChannelInboundHandler。而为解码字节流，需要扩展ByteToMessageDecoder（当int添加到List时，它将自动装箱到Integer类型），整个过程如下图所示。

![](../md/img/leesf456/616953-20170526093541154-254487211.png)
...
![](../md/img/leesf456/616953-20170526095714013-1420915341.png)
...
![](../md/img/leesf456/616953-20170526101859529-1483220582.png)
...
![](../md/img/leesf456/616953-20170526102145075-1931714558.png)
